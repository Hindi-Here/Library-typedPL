...
namespace GeometryLIB_Figure {
    ...
    inline double Figure2D_Points(initializer_list<double> args) { // площадь любой фигуры по точкам координат
    ...
    inline double Figure2D_Sides(initializer_list<double> args) { // площадь любой фигуры по сторонам фигуры
