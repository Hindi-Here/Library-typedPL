...
**Раздел FPFC** предоставляет инструенты для работы с контейнерами, строками, файлами, консолью. _P.S. Компонент File предоставляет лишь базовые группы методов по типу Read, Write, Append и Get функций - поэтому для более глубокой работы с файловами системами лушче воспользоваться иным решением._
